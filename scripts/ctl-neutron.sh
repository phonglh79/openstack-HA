...
function neutron_config {
        ...
        ops_edit $ctl_neutron_conf oslo_messaging_rabbit rabbit_hosts $MQ1_IP_NIC1:5672,$MQ2_IP_NIC1:5672,$MQ3_IP_NIC1:5672
        ...
        ops_edit $ctl_neutron_conf oslo_messaging_rabbit rabbit_max_retries 0
